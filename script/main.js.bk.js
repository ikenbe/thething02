var main = function(){
//set up game grid
	$("<div id =\"grid\" class=\"grid\"><div><div>R1C1<\/div><div>R1C2<\/div><div>R1C3<\/div><div>R1C4<\/div><\/div><div><div>R1C1<\/div><div>R1C2<\/div><div>R1C3<\/div><div>R1C4<\/div><\/div><div><div>R1C1<\/div><div>R1C2<\/div><div>R1C3<\/div><div>R1C4<\/div><\/div><div><div>R1C1<\/div><div>R1C2<\/div><div>R1C3<\/div><div>R1C4<\/div><\/div><\/div>")
...
//Grid size and cell size
	...
	$('.starter').click(function(){
		...
		$('.startset').slideUp(100,function(){
			$('.cell').css({'margin':(0.025*$g),'height':0.2*$g, 'width':0.2*$g});
...
function newGrid(){
	gridV=[];
	$('div.grid').find('div').each(function(i){
		gridV[i]=parseInt($(this).html());
	});
	$('div.grid').find('*').remove();
	$('<div class=\"row r1\"><div class=\"cell r1 c1\"><\/div><div class=\"cell r1 c2\"><\/div><div class=\"cell r1 c3\"><\/div><div class=\"cell r1 c4\" ><\/div><\/div><div class=\"row r2\"><div class=\"cell r2 c1\"><\/div><div class=\"cell r2 c2\"><\/div><div class=\"cell r2 c3\"><\/div><div class=\"cell r2 c4\" ><\/div><\/div><div class=\"row r3\"><div class=\"cell r3 c1\"><\/div><div class=\"cell r3 c2\"><\/div><div class=\"cell r3 c3\"><\/div><div class=\"cell r3 c4\" ><\/div><\/div><div class=\"row r4\"><div class=\"cell r4 c1\"><\/div><div class=\"cell r4 c2\"><\/div><div class=\"cell r4 c3\"><\/div><div class=\"cell r4 c4\" ><\/div><\/div>').appendTo('div.grid');
	$('div.grid').find('div').each(function(i){
		$(this).text(gridV[i]);
	});
...
console.log("Anything Moved?"+$('.r4.moved').size());
		...
		$('.remove').each(function(){$(this).parent().append('<div class=\"new cell\">0</div>');}).hide();
